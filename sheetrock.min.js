!function(e, t) {
    ...
    return function(e) {
        ...
        function o() {
            ...
            return r ? s.loadData(r, e) : n && o && s && (0,
            h.default)(s, e),
            this
        }
    ...
    , function(e, t, r) {
        ...
        function i(e) {
            var t = {};
            if (t.target = (0,
            d.extractElement)(e.target),
            t.fetchSize = Math.max(0, parseInt(e.fetchSize, 10) || 0),
            !t.target && !e.callback && !c.defaults.callback)
                throw new h.default("No element targeted or callback provided.");
    ...
    , function(e, t) {
        ...
        function r(e) {
            var t = e ? e.f || e.v || e : "";
            return t instanceof Array && (t = t.join("")),
            "object" === ("undefined" == typeof t ? "undefined" : l(t)) ? "" : ("" + t).replace(/^\s+|\s+$/, "")
        }
        function n(e) {
            var t = e;
            return "object" === ("undefined" == typeof t ? "undefined" : l(t)) && t.jquery && t.length && (t = t[0]),
            t && t.nodeType && 1 === t.nodeType ? t : null
        }
        function o(e, t) {
        ...
        var a = Object.assign || function(e) {
          ...
          , f = function() {
            function e(t) {
                if (o(this, e),
                this.options = t,
                this.index = t.requestIndex,
                this.state.failed)
                    throw new u.default("A previous request for this resource failed.");
                if (this.state.loaded)
                    throw new u.default("No more rows to load!")
            }
            return s(e, [{
                key: "update",
                value: function() {
                ...
                key: "state",
                get: function() {
                    var e = {}.hasOwnProperty.call(l.store, this.index)
                      , t = this.options.user.reset || this.options.request.data;
                    if (!e || t) {
                        var r = {
                            labels: e ? l.store[this.index].labels : null
                        };
            ...
            return s(e, [{
                ...
                value: function() {
                    ...
                    this.request.state.offset || (o = r.map(function(e, r) {
                        return e.label ? e.label.replace(/\s/g, "") : (n.last += 1,
                        n.rowNumberOffset = 1,
                        d.getCellValue(t[0].c[r]) || e.id)
                    }),
                    this.request.update({
                    ...
                    (!e || t.length - n.rowNumberOffset < e) && (n.last += 1,
                    this.request.update({
                        loaded: !0
                    }));
                ...
                value: function() {
                    var e = this;
                    this.rows = [],
                    this.request.state.offset || this.attributes.rowNumberOffset || this.rows.push(new u.default(0,this.attributes.labels,this.attributes.labels)),
                    this.raw.table.rows.forEach(function(t, r) {
        ...
        var o = function() {
          ...
          , s = function() {
            function e(t, r, o) {
                n(this, e),
                this.num = t,
                this.cellsArray = r.map(a.getCellValue),
                this.labels = o
            }
            return o(e, [{
                key: "cells",
    ...
    , function(e, t, r) {
        ...
        function o(e, t) {
            ...
            function o() {
                r(),
                t(new s.default("Request failed."))
            }
            var a = window.document.createElement("script")
              , l = "_sheetrock_callback_" + u;
            u += 1,
            window[l] = n,
            a.addEventListener && (a.addEventListener("error", o, !1),
            a.addEventListener("abort", o, !1)),
            a.type = "text/javascript",
            a.src = e.request.url + "&tqx=responseHandler:" + l,
            i.appendChild(a)
        }
        Object.defineProperty(t, "__esModule", {
            value: !0
